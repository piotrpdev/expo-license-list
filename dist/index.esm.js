...
var LicenseList = function (_a) {
    var rest = __rest(_a, []);
    return React.createElement(FlatList, __assign({}, rest, { keyExtractor: function (_a) {
            var key = _a.key;
            return key;
        } }));
};
...
var LicenseListItem = function (_a) {
    ...
    return (React.createElement(List.Item, { title: name, description: version + " \u2022 " + licenses + " \u2022 " + username, style: __assign({ margin: 5 }, style), onPress: function () { return onPress(repository); }, left: function (props) { return (React.createElement(Avatar.Image, __assign({}, props, { style: __assign(__assign(__assign({}, styles.avatar), props.style), leftStyle), source: { uri: image } }))); }, right: function (props) { return (React.createElement(List.Icon, __assign({}, props, { style: __assign(__assign({ alignSelf: "center" }, props.style), rightStyle), icon: iconName }))); } }));
};
...
export { LicenseList, LicenseListItem, extractNameFromGithubUrl, getLicensesFromJSON };
